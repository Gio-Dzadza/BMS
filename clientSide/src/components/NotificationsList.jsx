            ...
            if(userId){
                ...
                const response = await Axios.get(
                    ...
                    if (response.data) {
                        ...
                        // Now, uniqueNotifications contains only unique records based on the specified properties
                        // console.log(uniqueNotifications);
                    
                        // Set the unique notifications to your state or variable as needed
